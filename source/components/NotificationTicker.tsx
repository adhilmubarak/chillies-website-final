...
const NotificationTicker: React.FC<NotificationTickerProps> = ({ 
  ...
  const tickerClass = `fixed top-0 left-0 w-full z-[60] text-stone-900 text-[10px] md:text-xs font-bold uppercase tracking-widest overflow-hidden h-8 flex items-center border-b transition-colors duration-500 ${
    !isStoreOpen 
