...
const HappyHourView: React.FC<HappyHourViewProps> = ({ 
  ...
  return (
    <div className="w-full space-y-12 animate-fade-in">
      <div className="relative w-full h-72 md:h-96 overflow-hidden rounded-3xl border border-purple-500/30 bg-gradient-to-br from-purple-950/20 via-black to-white group">
        <div className="absolute inset-0 z-10 bg-gradient-to-r from-white via-transparent to-white pointer-events-none"></div>
