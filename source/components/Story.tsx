...
const Story: React.FC = () => {
  return (
    <section id="story" className="py-24 px-4 bg-stone-50 border-b border-stone-900/5 relative overflow-hidden scroll-mt-24">
        {/* Decorative Background */}
        <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-brand-500/20 to-transparent"></div>
        <div className="absolute -left-20 top-20 w-64 h-64 bg-brand-500/5 rounded-full blur-[100px] pointer-events-none"></div>
        <div className="absolute -right-20 bottom-20 w-64 h-64 bg-brand-500/5 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-serif text-stone-900 mb-16 leading-tight">
                The Story of <span className="text-brand-500">Chillies</span>
            </h2>
            
            <div className="space-y-10 text-lg md:text-xl text-stone-600 font-light leading-relaxed">
                <p>
                ...
                <div className="py-10 relative">
                    <Quote className="absolute top-0 left-1/2 -translate-x-1/2 text-brand-500/10 w-24 h-24 transform -translate-y-4" />
                    <p className="font-serif text-2xl md:text-3xl text-brand-400 italic relative z-10">
                        From the very first day, our journey has been shaped by one belief:
                        <span className="block mt-4 text-stone-900 not-italic font-bold tracking-wide text-3xl">Hard work matters.</span>
                    </p>
                </div>
                ...
                <div className="pt-10 border-t border-stone-900/5 mt-12 inline-block">
                    <p className="text-2xl font-serif text-stone-900">
                        Chillies is not just a restaurant.<br/>
                        <span className="text-brand-500 text-lg uppercase tracking-widest mt-2 block font-sans font-bold">It’s a story of persistence, flavor, and heart.</span>
                    </p>
                </div>
            </div>
        </div>
